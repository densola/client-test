...
const handleScrollAnimation = () => {
    scrollElements.forEach((el) => {
        // For every element than has the .js-scroll class
        if (elementInView(el)) {
            // If the top of the element is less than the viewport
            el.classList.add("appear"); // Add the .appear class
        } else if (elementOutofView(el)) {
            // If the top of the element is greater than the viewport
